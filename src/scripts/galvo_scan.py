...
class GalvoScanGeneric(Script):
    ...
    def setup_scan(self):
        ...
        #overrides x_array and y_array in subscript
    ...
    def get_galvo_location(self):
        ...
        """
        if self.settings['daq_type'] == 'PCI':
            galvo_position = self.daq_out.get_analog_voltages([self.settings['DAQ_channels']['x_ao_channel'],
    ...
    def set_galvo_location(self, galvo_position):
        ...
        """
        self.daq_out.set_analog_voltages({self.settings['DAQ_channels']['x_ao_channel']: galvo_position[0],
             self.settings['DAQ_channels']['y_ao_channel']: galvo_position[1]})
