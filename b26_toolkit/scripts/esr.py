...
class ESR(Script):
    ...
    _DEFAULT_SETTINGS = [
        ...
        Parameter('range_type', 'start_stop', ['start_stop', 'center_range'], 'start_stop: freq. range from freq_start to freq_stop. center_range: centered at freq_start and width freq_stop'),
        Parameter('freq_points', 100, int, 'number of frequencies in scan'),
        Parameter('integration_time', 0.05, float, 'measurement time of fluorescent counts (must be a multiple of settle time), per sample per point. The TOTAL integration time is integration_time * num_samps_per_pt'),
