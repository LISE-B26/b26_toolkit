...
class AutoFocusGeneric(Script):
    ...
    _SCRIPTS = {'take_image': NotImplemented}
    _INSTRUMENTS = {}
...
class AutoFocusDAQ(AutoFocusGeneric):
    ...
    Autofocus: Takes images at different piezo voltages and uses a heuristic to figure out the point at which the objective is focused.
    """
    _INSTRUMENTS = {'z_piezo': PiezoController}
...
class AutoFocusDAQCold(AutoFocusDAQ):
    ...
    _INSTRUMENTS = {'z_piezo': PiezoControllerCold}
...
class AutoFocusPhotodiode(AutoFocusDAQ):
    _SCRIPTS = {'take_image': GalvoScanPhotodiode}
...
class AutoFocusDAQNVTracking(AutoFocusDAQ):
    ...
    """
    _SCRIPTS = {'take_image': GalvoScan, 'find_NV': FindNv, 'set_laser': SetLaser}
    _INSTRUMENTS = {'z_piezo': MDT693A}
...
class AutoFocusTwoPoints(AutoFocusDAQ):
    _SCRIPTS = {'take_image': GalvoScan, 'take_image_2': GalvoScan}
...
class AutoFocusDaqOptotune(AutoFocusDAQ):
    _INSTRUMENTS = {'ELens': OptotuneLens}
