...
class GalvoScanPulsed(GalvoScan):
    _DEFAULT_SETTINGS = [
        Parameter('point_a',
    ...
    def get_galvo_location(self):
        ...
        if self.settings['daq_type'] == 'PCI':
            set_laser_daq_channels = self.scripts['SetLaser'].settings['DAQ_channels']
            initial_position = self.instruments['NI6259']['instance'].get_analog_voltages([set_laser_daq_channels['x_ao_channel'], set_laser_daq_channels['y_ao_channel']])
        else:
            initial_position = []
