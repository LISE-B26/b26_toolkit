    ...
    def _create_pulse_sequences(self):
        ...
        for tau in tau_list:
            ...
            [
                ...
                Pulse(microwave_channel, laser_off_time + pi_half_time + tau + pi_time + 2*tau, pi_time),
                Pulse(microwave_channel, laser_off_time + pi_half_time + tau + pi_time + 2*tau + pi_time + tau, three_pi_half_time)
            ]

            end_of_first_CPMG = laser_off_time + pi_half_time + tau + pi_time + 2*tau + pi_time + tau + three_pi_half_time
            ...
            pulse_sequence = \
                [
                    Pulse(microwave_channel, start_of_second_CPMG, pi_half_time),
                    Pulse(microwave_channel, start_of_second_CPMG + pi_half_time + tau, pi_time),
                    Pulse(microwave_channel, start_of_second_CPMG + pi_half_time + tau + pi_time + 2 * tau, pi_time),
                    Pulse(microwave_channel, start_of_second_CPMG + pi_half_time + tau + pi_time + 2 * tau + pi_time + tau,
                          pi_half_time)
                ]

            end_of_second_CPMG = start_of_second_CPMG + pi_half_time + tau + pi_time + 2 * tau + pi_time + tau + three_pi_half_time
