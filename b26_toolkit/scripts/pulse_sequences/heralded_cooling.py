...
class HeraldedCoolingNSweep(PulsedExperimentBaseScript):
    _DEFAULT_SETTINGS = [
        ...
        Parameter('n_start', 2.82e9, float, 'start frequency of scan in Hz'),
        Parameter('n_stop', 2.92e9, float, 'end frequency of scan in Hz'),
