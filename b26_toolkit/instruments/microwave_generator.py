...
class MicrowaveGenerator(Instrument):
    ...
    _DEFAULT_SETTINGS = Parameter([
        ...
        Parameter('port', 3, list(range(0, 31)), 'GPIB or COM port on which to connect'), ## JG: what out for the ports this might be different on each computer and might cause issues when running export default
